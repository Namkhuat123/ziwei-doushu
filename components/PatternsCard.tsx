...
import { PALACE_NAME_VI } from '@/lib/ziwei/constants';
  ...
  return (
    ...
    >
      <div className="text-[10px] tracking-widest mb-3 flex items-center gap-2" style={{ color: 'var(--t-faint)' }}>
        ...
        Phân Biệt Cách Cục (theo điều kiện cổ thư nghiêm ngặt)
        <span className="text-[9px] ml-auto" style={{ color: 'var(--t-faint)', opacity: 0.75 }}>{patterns.length} cái</span>
      </div>
